const { getDatabase, closeDatabase, connectDatabase } = require('../getDatabase');
...
describe('Database setup methods', () => {
  ...
  describe('closeDatabase', () => {
    ...
    it('Should stop connections after being executed', () => new Promise((resolve, reject) => {
      connectDatabase()
        .then(() => closeDatabase())
        .catch((error) => {
          reject(error);
    ...
    it('Should not throw an error if called when the database is already close', () => new Promise((resolve, reject) => {
      connectDatabase()
        .then(() => closeDatabase())
        .then(() => closeDatabase())
        .then(() => {
  ...
  describe('connectDatabase', () => {
    ...
    it('Connecting the database should return an object', () => new Promise((resolve, reject) => {
      connectDatabase()
        .then((db) => {
    ...
    it('Should throw an error if the database is already connected', () => new Promise((resolve, reject) => {
      connectDatabase()
        .then(() => connectDatabase())
        .then(() => {
          reject(new Error('Should have thrown an error'));
